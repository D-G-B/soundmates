...
password: "123456")
file = URI.open('https://res.cloudinary.com/deblg8cgb/image/upload/v1615374499/6gefl1j0i10lxatvgkrqmu80836g.jpg')
...
password: "123456")
file = URI.open('https://res.cloudinary.com/deblg8cgb/image/upload/v1615376231/z5opi6ezci9uq3ulwqoyknhwanfu.jpg')
...
password: "123456")
file = URI.open('https://res.cloudinary.com/deblg8cgb/image/upload/v1615376326/tlccvjaif988b2iaxbr6uxjff3sa.jpg')
...
# # Kevin youtube
# Share.create!(link: "https://www.youtube.com/watch?v=Xmr97isqg5k&t=4408s&ab_channel=CCTVRadio",
#   platform: "YouTube",
#   user_id: kevin.id,
#   genre_id: funk_soul.id)

# # Kevin spotify
# Share.create!(link: "https://open.spotify.com/track/7dLwZkHixHbTtbauejtzrm?si=b3e645cd9ce24320",
#   platform: "Spotify",
#   user_id: kevin.id,
#   genre_id: funk_soul.id)
...
# # Herve spotify
# Share.create!(link: "https://open.spotify.com/track/4YwCG8mXQrtQI6oQykhW7j?si=907a0030fddf46e9",
#   platform: "Spotify",
#   user_id: herve.id,
#   genre_id: electronic.id)
...
# # Janelle YouTube
# Share.create!(link: "https://www.youtube.com/embed/PaYvlVR_BEc",
#   platform: "Youtube",
#   user_id: janelle.id,
#   genre_id: pop.id)

# # Janelle Spotify
# Share.create!(link: "https://open.spotify.com/track/5gW5dSy3vXJxgzma4rQuzH?si=6cb5bdc3ffd84615",
#   platform: "Spotify",
#   user_id: janelle.id,
#   genre_id: funk_soul.id)
...
# # Ada Youtube
# Share.create!(link: "https://www.youtube.com/embed/Kf9ZNwfQ7CY",
#   platform: "Youtube",
#   user_id: ada.id,
#   genre_id: stage.id)

# # Ada Spotify
# Share.create!(link: "https://open.spotify.com/track/0UWIOxNBY6FCh1Qlxo2iPU?si=38dcfe578ff448cb",
#   platform: "Spotify",
#   user_id: ada.id,
#   genre_id: stage.id)
